...
public class Add_employee implements ActionListener {
	...
	JLabel Lab2 = new JLabel(" Add new Employee ");
...
///code to add email
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == btn) {
			...
			String Eid = String.valueOf(number);

			try {
				Conn conn = new Conn();
				String query = "insert into Employee values('" + Eid + "','" + fullname + "','" + fname + "','"
						+ mname + "','"+educ+"','" + design + "','" + salar + "','" + phone + "','" + addres + "','" + gmail
						+ "','" + Date + "')";
